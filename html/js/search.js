...
async function callSearchApi() {
    ...
    document.getElementById("danawaCount").innerText =
        "검색중";
...
async function callDanawaSearch(keyword) {
    try {
        const res = await fetch("/Search/danawa", {
            method: "POST",
        ...
        platformCounts.danawa =
            data.count || 0;


        document.getElementById("danawaCount").innerText =
            platformCounts.danawa + "개";
